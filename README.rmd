...
```
pipx install pre-commit # use pipx to avoid polluting your global python environment
# pip install pre-commit # if you don't want to use pipx

# Then run in the root of repo:
pre-commit install # Will take 2-3 minutes to run
#pre-commit run --all #Optionally run all checks over all files
```
